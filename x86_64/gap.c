...
#define dt _nt->_dt
#define g _p[0]
#define selected_for_report _p[1]
#define vgap _p[2]
#define i _p[3]
#define synapseID _p[4]
#define v _p[5]
#define _g _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 Gap /gpfs/bbp.cscs.ch/home/tharayil/generalized-neurodamus-py/neurodamus-py/mods.tmp/gap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/gpfs/bbp.cscs.ch/home/tharayil/generalized-neurodamus-py/neurodamus-py/mods.tmp/gap.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "POINT_PROCESS Gap\n"
  "RANGE vgap\n"
